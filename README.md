...
👉 Do you want me to also generate **individual README.md for each week’s folder** (like `Week-1/README.md` with program list), or only **one master README** for the whole repo?
